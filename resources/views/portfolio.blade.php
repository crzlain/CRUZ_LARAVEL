            ...
            <nav id="navbar" class="navbar navbar-expand-lg position-fixed top-0 ms-auto">
                ...
                <div class="collapse navbar-collapse shadow-bg" id="navbarNavAltMarkup">
                    <div class="navbar-nav p-5">
                        <a class="nav-item nav-link active text-center mx-3" href="./index.html#home">Home</a>
                        <a class="nav-item nav-link text-center mx-3" href="./index.html#portfolio">Portfolios</a>
                        <a class="nav-item nav-link text-center mx-3" href="./index.html#team">Team</a>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row justify-content-lg-start justify-content-center buttons">
                                <div class="col-7 col-sm-3 col-lg-5">
                                    <a class="main-button btn-view-portfolio text-center"
                                        href="./index.html#portfolio">View
                                        portfolio</a>
                                </div>
                                <div class="col-7 col-sm-3 col-lg-5">
            ...
            <div class="portfolio">
                        ...
                        <div class="portfolio-header">
                            <div class="row align-items-end">
                                ...
                                <div class="col-sm-11 col-lg-7">
                                    <p class="title">Business website</p>
                                    <p>Graphic design</p>
                                </div>
                                <div class="col-sm-1 col-md-1 ms-auto">
                                    <a href="./index.html#portfolio"><i class="bi bi-arrow-left"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="portfolio-body">
                    <div class="container text-center mb-5">
                        <img class="img-fluid" src="http://via.placeholder.com/1040x1360" alt="placeholder">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="row justify-content-between">
                        <div class="contact-form col-12 col-sm-6 col-md-7">
                            <h2>Contact</h2>
                            <form action="mailto:you@yourdmainhere.com" method="post" class="needs-validation"
                                novalidate>
                                <div class="form-group mt-5">
                                    <label class="col-12">Full Name</label>
                                    <input class="col-12" type="text" id="fname" placeholder="Full name" name="fname"
                                        required>
                                    <div class="invalid-feedback warning">Please write a full
                                        name.</div>
                                </div>
                                <div class="form-group mt-5">
                                    ...
                                    <input class="col-12" type="email" id="email" placeholder="E-mail" name="email"
                                        required>
                                    <div class="invalid-feedback warning">Please write a correct
                                        e-mail.</div>
                                </div>
                                <div class="form-group mt-5">
                                    ...
                                    <input class="col-12" type="text" id="message" placeholder="Message" name="message"
                                        required>
                                    <div class="invalid-feedback warning">Please write a
                                        message.</div>
                                </div>
                            ...
                            <div class="media row my-5">
                                ...
                                <div class="col-12 col-lg-4 mt-5 mt-md-0">
                                    <p>My phone</p>
                                    <a href="tel:+00-000-00-00" class="warning">+00 000 00
                                        00</a>
                                </div>
                            </div>
